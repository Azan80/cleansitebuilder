...
import { ArrowRight, Sparkles, Globe, Cpu, CheckCircle2, Layout, Image as ImageIcon, Type, Menu, Search, ShoppingBag } from "lucide-react";
    ...
    <section className="relative min-h-screen flex flex-col pt-32 pb-20 overflow-hidden bg-[#030712]">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          >
            The AI-powered builder that turns your prompts into production-ready Next.js websites. Optimized for SEO, speed, and growth—shipped to the edge in seconds.
          </motion.p>
          ...
          >
            <p className="text-sm text-gray-400 font-medium tracking-wide">Make your Next.js website live</p>
            <div className="relative group">
              <div className="absolute -inset-4 bg-white/20 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
              <svg 
                viewBox="0 0 180 180" 
                fill="none" 
                xmlns="http://www.w3.org/2000/svg"
                className="w-24 h-24 md:w-32 md:h-32 relative z-10 drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]"
              >
